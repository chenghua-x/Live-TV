...
//	})
	...
	r.GET(base_path + "/tv-888.m3u", func(c *gin.Context) {
		if enableTV {
	...
	r.GET(base_path + "/bililive.m3u", func(c *gin.Context) {
	...
	r.GET(base_path + "/huyayqk.m3u", func(c *gin.Context) {
		yaobj := &list.HuyaYqk{}
	...
	r.GET(base_path + "/douyuyqk.m3u", func(c *gin.Context) {
		yuobj := &list.DouYuYqk{}
	...
	r.GET(base_path + "/yylunbo.m3u", func(c *gin.Context) {
